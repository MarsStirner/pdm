...
/**
 * <p>Java class for PRPA_MT101310UV02.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT101310UV02.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asEmployee" type="{urn:hl7-org:v3}PRPA_MT101310UV02.Employee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}PRPA_MT101310UV02.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}PRPA_MT101310UV02.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}PRPA_MT101310UV02.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}PRPA_MT101310UV02.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asRole" type="{urn:hl7-org:v3}PRPA_MT101310UV02.Role" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}PRPA_MT101310UV02.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}PRPA_MT101310UV02.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="personalRelationship" type="{urn:hl7-org:v3}PRPA_MT101310UV02.PersonalRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}PRPA_MT101310UV02.BirthPlace" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPA_MT101310UV02.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT101310UV02.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT101310UV02Person {
    ...
    protected List<PRPAMT101310UV02Employee> asEmployee;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02Citizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02Student> asStudent;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02Member> asMember;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02OtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02Role> asRole;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02ContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02Guardian> guardian;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02PersonalRelationship> personalRelationship;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT101310UV02BirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<PRPAMT101310UV02LanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02Employee }
     * 
     * 
     */
    public List<PRPAMT101310UV02Employee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<PRPAMT101310UV02Employee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02Citizen }
     * 
     * 
     */
    public List<PRPAMT101310UV02Citizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<PRPAMT101310UV02Citizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02Student }
     * 
     * 
     */
    public List<PRPAMT101310UV02Student> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<PRPAMT101310UV02Student>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02Member }
     * 
     * 
     */
    public List<PRPAMT101310UV02Member> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<PRPAMT101310UV02Member>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02OtherIDs }
     * 
     * 
     */
    public List<PRPAMT101310UV02OtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<PRPAMT101310UV02OtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02Role }
     * 
     * 
     */
    public List<PRPAMT101310UV02Role> getAsRole() {
        if (asRole == null) {
            asRole = new ArrayList<PRPAMT101310UV02Role>();
        }
        return this.asRole;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02ContactParty }
     * 
     * 
     */
    public List<PRPAMT101310UV02ContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<PRPAMT101310UV02ContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02Guardian }
     * 
     * 
     */
    public List<PRPAMT101310UV02Guardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<PRPAMT101310UV02Guardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02PersonalRelationship }
     * 
     * 
     */
    public List<PRPAMT101310UV02PersonalRelationship> getPersonalRelationship() {
        if (personalRelationship == null) {
            personalRelationship = new ArrayList<PRPAMT101310UV02PersonalRelationship>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT101310UV02BirthPlace }{@code >}
     *     
     */
    public JAXBElement<PRPAMT101310UV02BirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<PRPAMT101310UV02BirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT101310UV02LanguageCommunication }
     * 
     * 
     */
    public List<PRPAMT101310UV02LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPAMT101310UV02LanguageCommunication>();
        }
